...
|--------------------------|-------------------------------|------------------|
| **Comunica oralmente con efectividad a diferentes rangos de audiencia.** | **Tello Palacios, Fabrizio Rafael**<br> **AV1**<br> Se comunicó eficazmente los avances del proyecto al equipo y la explicación del flujo de trabajo en Git (rama develop). Esto permitió transmitir de forma clara tanto los requerimientos como la estructura y gestión del proyecto. <br><br> **TB1**<br> Durante el TB1 comunicó oralmente los avances correspondientes al Sprint 2 y al Bounded Context *Automation Scenes*, explicando su funcionamiento y objetivos. Esto permitió que el equipo comprendiera los escenarios de automatización definidos y se mantuviera alineado con el desarrollo del sistema.<br><br> **Checa Burga, Oscar Diego**<br>**AV1**<br> Se comunicó eficientemente durante los avances del proyecto, permitiendo realizar avances más rápidos. Esto permitio una mejor organización del proyecto y la realización del mismo<br><br> **TB1**<br> Se comunicó eficientemente los avances del proyecto, tanto de la Landing Page como de la Web App, incluyendo la implementación de i18n y los Bounded Context *Analytics & Dashboard* y *History & Audit*. Esto permitió una mejor organización y colaboración dentro del equipo.<br><br> **Quispe llacsahuanga, César Agusto**<br>**AV1**<br>Expuso la estructura de la Landing Page y la lógica de navegación del sistema, permitiendo que el equipo comprenda cómo interactúa el usuario con la plataforma de forma sencilla y ordenada.<br><br> **TB1**<br> Durante el TB1 expuso los avances de la Landing Page, la creación de repositorios adicionales y la funcionalidad de los Bounded Context *IAM* y *Smart Integrations*, facilitando la comprensión del alcance funcional del sistema.<br><br>**Esquicha Alcántara, Diego Alonso**<br>**AV1**<br> <br><br> **TB1**<br> Durante el TB1 lideró las sesiones de EventStorming, explicó la definición de los Bounded Context a trabajar y presentó los Wireflows y Userflows del sistema. Asimismo, expuso el contenido del PPT de presentación, adaptando la comunicación a audiencias técnicas y no técnicas.<br><br> **Rocha Cotrina, Alvaro** <br>**AV1**<br>Durante el desarrollo del proyecto, participé en la explicación de la organización del repositorio, el uso de ramas y el flujo de trabajo en Git, lo que permitió que el equipo comprendiera cómo gestionar correctamente los cambios y la integración del proyecto. Asimismo, al exponer los avances y la estructura de las secciones desarrolladas, adapté el nivel de detalle según el tipo de audiencia, facilitando tanto la comprensión técnica como general del sistema DomotiCore. Esto contribuyó a una mejor coordinación del equipo y a una presentación clara de los resultados obtenidos.<br><br> **TB1**<br> En el TB1 expuso la implementación de los Bounded Context *Devices Control* y *Device Management* en el frontend, así como los *Software Architecture Diagrams*, permitiendo al equipo comprender la arquitectura del sistema y la relación entre sus componentes. | El desarrollo del proyecto permitió integrar herramientas de análisis, diseño y control de versiones, logrando una solución coherente y bien estructurada. Asimismo, se evidenció la importancia de una comunicación clara y adaptada a distintos tipos de audiencia para asegurar la comprensión y el éxito del trabajo realizado. |

| **Comunica por escrito con efectividad a diferentes rangos de audiencia** | **Tello Palacios, Fabrizio Rafael**<br> **AV1**<br> Se comunicaron por escrito los avances del proyecto de forma clara y estructurada la documentación del flujo de trabajo en Git. Esto permitió adaptar el contenido tanto para audiencias técnicas como no técnicas. <br><br> **TB1**<br> Durante el TB1 documentó por escrito los avances del Sprint 2 y del Bounded Context *Automation Scenes*, describiendo de manera clara los procesos y decisiones técnicas adoptadas.<br><br> **Checa Burga, Oscar Diego**<br>**AV1**<br> Se comunico por escrito los avances del proyecto, asi como la creacion de landing page. Esto permitió adaptar el contenido a las necesidades de nuestros usuarios. <br><br> **TB1**<br> Se comunicó por escrito los avances del proyecto, así como la creación de la Landing Page y la implementación de i18n. Esto permitió adaptar el contenido a las necesidades de los usuarios. Además, documentó dos Bounded Context: *Analytics & Dashboard* y *History & Audit*.<br><br> **Quispe llacsahuanga, César Agusto**<br>**AV1**<br>Elaboró contenidos relacionados a la Landing Page, organizando la información de manera estructurada para facilitar su comprensión y coherencia con el diseño del sistema. Realizo avances en todos los capitulos en diferentes puntos. <br><br> **TB1**<br> Durante el TB1 elaboró y corrigió los capítulos 4 y 5, documentó la Landing Page y los Bounded Context *IAM* y *Smart Integrations*, manteniendo coherencia con el diseño general del sistema.<br><br>**Esquicha Alcántara, Diego Alonso**<br>**AV1**<br>Asimismo, los avances fueron documentados por escrito de forma ordenada y precisa, detallando el flujo de trabajo en Git. Esta documentación permitió presentar la información de manera adaptable, resultando clara tanto para perfiles técnicos como para quienes no cuentan con formación técnica. <br><br> **TB1**<br> En el TB1 documentó los resultados del EventStorming, la definición de los Bounded Context y el capítulo 4 con Wireflows y Userflows, además de estructurar el contenido del PPT de presentación.<br><br> **Rocha Cotrina, Alvaro** <br>**AV1**<br>A lo largo del proyecto, participé en la redacción y organización de distintas secciones del documento, como User Stories, Product Backlog, Style Guidelines y Architecture, asegurando una estructura clara, coherente y alineada con los requerimientos del curso. Además, se utilizaron recursos como tablas, listas y descripciones detalladas que facilitaron la comprensión tanto para lectores técnicos como no técnicos. De esta manera, se logró transmitir la información de forma ordenada y precisa, permitiendo entender el funcionamiento, diseño y alcance de la solución propuesta.<br><br> **TB1**<br> Durante el TB1 documentó los *Software Architecture Diagrams* y la descripción de los Bounded Context *Devices Control* y *Device Management*, asegurando claridad y coherencia en la información técnica presentada. | En conclusión, la documentación desarrollada evidenció la capacidad de transmitir información de manera escrita con claridad y coherencia, facilitando la comprensión del proyecto en distintos niveles. Asimismo, se demostró que el uso de recursos estructurados y visuales mejora la comunicación y el entendimiento entre los diferentes actores involucrados. |
